...
const AdminHotelScreen = () => {
  ...
  const submitHotel = () => {
    ...
    const url = "https://travelix19.onrender.com/add/hotel";
  ...
  const listAllHotels = () => {
    const url = "https://travelix19.onrender.com/list/hotel";
  ...
  const deleteHotel = (value) => {
    const url = "https://travelix19.onrender.com/delete/hotel/" + value.id;
