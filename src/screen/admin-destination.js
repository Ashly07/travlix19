...
const AdminDestinationScreens = () => {
  ...
  const submitDestination = () => {
    ...
    const url = "https://travelix19.onrender.com/add/destination";
  ...
  const listAllDestination = () => {
    const url = "https://travelix19.onrender.com/list/destination";
  ...
  const deleteDestination = (value) => {
    const url = "https://travelix19.onrender.com/delete/destination/" + value.id;
